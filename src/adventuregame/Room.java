...
class Room {
	...
	static void setupRooms(HashMap<String,Room> roomList) {
		...
		r = new Room("DEEPNEST", "The deepest area of Hallownest. In this enormous, spider infested, dark sprawl of narrow passages, Herrah the Beast, in deep rest, can be found. "
